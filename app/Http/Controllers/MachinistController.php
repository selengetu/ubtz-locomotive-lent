...
class MachinistController extends Controller
{
    ...
    public function index()
    {
      ...
      $zurch= FaultDetail::where('fault_type',2)->orderby('fault_detail_name')->get();
        ...
        if ($machinist!=NULL && $machinist !=0) {
         ...
         $zurchil=DB::select('select  * from ZURCHILDEVTER t where t.depocode = '.Auth::user()->depo_id.  ' '.$query. 'and rownum<=1000');
      ...
      public function indexzurchil()
    {
        ...
        return view('tailan.mashzurchil')->with(['zurchil'=>$zurchil,'zurch'=>$zurch,'machinist' => $machinist, 'startdate' =>$startdate, 'enddate' => $enddate]);
    }
    ...
    public function masha8()
    {
      ...
      $zurch= FaultDetail::where('fault_type',2)->orderby('fault_detail_name')->get();
        ...
        return view('tailan.masha8')->with(['zurchil'=>$zurchil,'zurch'=>$zurch,'machinist' => $machinist, 'startdate' =>$startdate, 'enddate' => $enddate]);
    }
    public function masholon()
    {
       if (!Cache::has('Machinist')) 
        {
        $v = Cache::remember('Machinist', 2, function() {
      ...
      $zurch= FaultDetail::where('fault_type',2)->orderby('fault_detail_name')->get();
        ...
        return view('tailan.masholon')->with(['zurchil'=>$zurchil,'zurch'=>$zurch,'machinist' => $machinist, 'startdate' =>$startdate, 'enddate' => $enddate]);
    }
