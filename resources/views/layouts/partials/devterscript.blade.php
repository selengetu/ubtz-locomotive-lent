...
<script type="text/javascript">
   ...
   $("#techno_timefin, #techno_stat").change(function(){
   calculateTime();
 ...
 function calculateTimemodal() {
             ...
             //create date format          
              var diff =(dt2.getTime() - dt1.getTime()) / 1000;
              diff /= 60;
              if($('#techno_statmodal').val() == 84 || $('#techno_statmodal').val() == 484){
                diff -=80;  
                 }
              if($('#techno_statmodal').val() == 76){
                diff -=52;  
                 }
              $("#techno_zogssonmodal").val(diff);     
             
    }
   $("#techno_timefinmodal, #techno_statmodal").change(function(){
   calculateTimemodal();
