<script type="text/javascript">
   function destroyhajuu(itag)
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonhoorond_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonurtuu30_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonuharsan_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbontuslamj_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbongraphiluu_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbongraphbus_id').val();
          ...
          $.ajax(
        {
            ...
            success: function ()
            {
                alert('Графикийн бус устгагдлаа');
                 marshgraphbus(marsh);
            },
             error: function (jqXHR, textStatus, errorThrown) {
                  if (jqXHR.status == 500) {
         ...
         {
             var marsh = $('#ribbonzurchilepkgemtel_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilhurd_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchil45_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchileffect_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchiltormozburuu_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilepkhaasan_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilkran_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchiltormoztursh_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchiloroh_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilgolhooloi_id').val();
   ...
   {
       var marsh = $('#ribbonzurchilepkajil_id').val();
   ...
   function destroyepkkon(itag)
   {
       var marsh = $('#ribbonzurchilepkkon_id').val();

       $.ajax(
           {
               url: "epkkon/delete/"+itag,
               type: 'GET',
               dataType: "JSON",
               data: {
                   "id": itag,
         ...
         {
             var marsh = $('#ribbonzurchilyaraltai_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchil20_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilhii_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilanhaaramj_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilduud_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilkilo_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilbuguiwch_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilklub_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchiljoloo_id').val();
   ...
   function destroyjolood(itag)
   {
       var marsh = $('#ribbonzurchiljolood_id').val();

       $.ajax(
           {
               url: "jolood/delete/"+itag,
               type: 'GET',
               dataType: "JSON",
               data: {
                   "id": itag,
               ...
               success: function ()
               {
                   alert(' Жолоодлогын бариул хугацаа бариагүй татсан устгагдлаа');
                   marshjolood(marsh);
               },
               error: function (jqXHR, textStatus, errorThrown) {
                   if (jqXHR.status == 500) {
   ...
   {
       var marsh = $('#ribbonzurchilbusad_id').val();
   ...
   function destroybusaduzuulelt(itag)
   {
       var marsh = $('#busad_id').val();

       $.ajax(
           {
               url: "busaduzuulelt/delete/"+itag,
               type: 'GET',
               dataType: "JSON",
               data: {
                   "id": itag,
               ...
               success: function ()
               {
                   alert('Бусад үзүүлэлт устгагдлаа');
                   marshbusaduzuulelt(marsh);
               },
               error: function (jqXHR, textStatus, errorThrown) {
                   if (jqXHR.status == 500) {
                       alert('Internal error: ' + jqXHR.responseText);
         ...
         {
             var marsh = $('#ribbonzurchilepkshilj_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilhurdhemjigch_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilbichlegbudeg_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchilbichlegdutuu_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchiltsag_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchiltuuzzassan_id').val();
          ...
          $.ajax(
        {
         ...
         {
             var marsh = $('#ribbonzurchiltuuzuragdsan_id').val();
   ...
   {
       var marsh = $('#ribbonanhaaramj_id').val();
   ...
   function updatehaluun(itag)
   {
       ...
       $.get('gethaluun/'+itag,function(data){
           $.each(data,function(i,qwe){
               ...
               $('#haluun_typemodal').val(qwe.hotstand_type);
           });
      ...
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
                ...
                $('#urtuu30_zogssonmodal').val(qwe.stoptime);
                 $('#urtuu30_reasonmodal').val(qwe.reason);
         });
      ...
      $.get('getmarshfault/'+itag,function(data){
             $.each(data,function(i,qwe){
                $('#hajuu_urtuumodal').val(qwe.fault_from);
      ...
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#hoorond_statmodal').val(qwe.fault_from);
      ...
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#205_frommodal').val(qwe.fault_from);
                $('#205_tomodal').val(qwe.fault_to);
      ...
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#const_frommodal').val(qwe.fault_from);
                $('#const_fault').val(qwe.fault_id);
                $('#const_tomodal').val(qwe.fault_from);
      ...
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#tuslamj_frommodal').val(qwe.fault_from);
                 $('#tuslamj_tomodal').val(qwe.fault_to);
                ...
                $('#tuslamj_minmodal').val(qwe.stoptime);
                 $('#tuslamj_reasonmodal').val(qwe.reason);
      ...
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#uharsan_statmodal').val(qwe.fault_from);
                $('#uharsan_fault').val(qwe.fault_id);
                $('#uharsan_timemodal').val(qwe.fault_time);
                $('#uharsan_speedmodal').val(qwe.over_speed);
                 $('#uharsan_kmmodal').val(qwe.constspeed);
                 $('#uharsan_minmodal').val(qwe.stoptime);
             ...
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                ...
                $('#graphiluu_zogssonmodal').val(qwe.stoptime);
                 $('#graphiluu_reasonmodal').val(qwe.reason);
             ...
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                ...
                $('#graphbus_zogssonmodal').val(qwe.stoptime);
                 $('#graphbus_reasonmodal').val(qwe.reason);
     ...
     function updateepkgemtel(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilepkgemtel_statmodal').val(qwe.fault_from);
     ...
     function updatetormozburuu(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
                $('#zurchiltormozburuu_statmodal').val(qwe.fault_from);
     ...
     function updateepkhaasan(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilepkhaasan_statmodal').val(qwe.fault_from);
  ...
  function updateepkajil(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilepkajil_statmodal').val(qwe.fault_from);
   ...
   function updateepkkon(itag){
       $.get('getmarshfaultdet/'+itag,function(data){
           $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
               $('#zurchilepkkon_statmodal').val(qwe.fault_from);
               $('#ribbonzurchilepkkon_fault').val(qwe.fault_id);
               $('#zurchilepkkon_typemodal').val(qwe.broketype);
               $('#zurchilepkkon_isstopmodal').val(qwe.is_stop);
               $('#zurchilepkkon_aktmodal').val(qwe.is_techact);
               $('#zurchilepkkon_zogssonmodal').val(qwe.stoptime);
               $('#zurchilepkkon_timemodal').val(qwe.fault_time);
             ...
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                ...
                $('#zurchilduud_timemodal').val(qwe.fault_time);
                 $('#zurchilduud_typemodal').val(qwe.broketype).trigger('change');
  ...
  function updateyaraltai(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilyaraltai_statmodal').val(qwe.fault_from);
                ...
                $('#zurchilyaraltai_attackmodal').val(qwe.is_stop).trigger('change');
                $('#zurchilyaraltai_typemodal').val(qwe.broketype).trigger('change');
                 $('#zurchilyaraltai_reasonmodal').val(qwe.reason);
             ...
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                ...
                $('#zurchiltormoztursh_turshmodal').val(qwe.is_stop);
                 $('#zurchiltormoztursh_typemodal').val(qwe.broketype).trigger('change');
  ...
  function updatetuuzuragdsan(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchiltuuzuragdsan_statmodal').val(qwe.fault_from);
  ...
  function updatebichlegbudeg(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
                ...
                $('#zurchilbichlegbudeg_statmodal').val(qwe.fault_from);
  ...
  function updatebichlegdutuu(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilbichlegdutuu_statmodal').val(qwe.fault_from);
  ...
  function updatehurdhetruulsen(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilhurd_frommodal').val(qwe.fault_from);
                $('#zurchilhurd_tomodal').val(qwe.fault_to);
  ...
  function updateklub(itag){
      $.get('getmarshfault/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilklub_frommodal').val(qwe.fault_from);
                $('#zurchilklub_tomodal').val(qwe.fault_to);
  ...
  function updatehii(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilhii_statmodal').val(qwe.fault_from);
                $('#ribbonzurchilhii_fault').val(qwe.fault_id);
                $('#zurchilhii_reasonmodal').val(qwe.reason);
                 $('#zurchilhii_nummodal').val(qwe.over_speed);
         });
      ...
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                ...
                $('#zurchilhurdhemjigch_statmodal').val(qwe.fault_from);
  ...
  function updatetsag(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchiltsag_statmodal').val(qwe.fault_from);
  ...
  function updatekilo(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilkilo_frommodal').val(qwe.fault_from);
                $('#zurchilkilo_tomodal').val(qwe.fault_to);
                 $('#zurchilkilo_kmmodal').val(qwe.fault_km);
...
function updateattention(itag){
      $.get('getmarshfaultdet/'+itag,function(data){
             $.each(data,function(i,qwe){
               // $('#dep').val(qwe.dep_id);
                $('#zurchilanhaaramj_statmodal').val(qwe.fault_from);
...
function updatebusad(itag){
   ...
   function updatebusaduzuulelt(itag){
       $.get('getmarshfaultdet/'+itag,function(data){
           $.each(data,function(i,qwe){
               $('#busad_fault').val(qwe.fault_id);
               $('#busad_reasonmodal').val(qwe.reason);
           });
   ...
   $('#epkkonmodal').submit(function(event){
       event.preventDefault();
       ...
       $.ajax(
           {
               type: 'POST',
               url: 'updateepkkon',
               data: $('form#epkkonmodal').serialize(),
               success: function ()
               {
                   alert('ЭПК kon засагдлаа');
                   marshepkkon(marsh);
               },
               error: function (jqXHR, textStatus, errorThrown) {
                   if (jqXHR.status == 500) {
   ...
   $('#joloodmodal').submit(function(event){
       event.preventDefault();
       ...
       $.ajax(
           {
               type: 'POST',
               url: 'updatejolood',
               data: $('form#joloodmodal').serialize(),
               success: function ()
               {
                   alert(' Жолоодлогын бариул хугацаа бариагүй татсан засагдлаа');
                   marshjolood(marsh);
               },
               error: function (jqXHR, textStatus, errorThrown) {
                   if (jqXHR.status == 500) {
   ...
   $('#modalbusaduzuulelt').submit(function(event){
       event.preventDefault();
       ...
       $.ajax(
           {
               type: 'POST',
               url: 'updatebusaduzuulelt',
               data: $('form#modalbusaduzuulelt').serialize(),
               success: function ()
               {
                   alert('Бусад үзүүлэлт засагдлаа');
                   marshbusaduzuulelt(marsh);
               },
               error: function (jqXHR, textStatus, errorThrown) {
                   if (jqXHR.status == 500) {
