        ...
        <script src="{{ asset('assets/global/scripts/tableexport.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('/assets/layouts/global/scripts/mask.js') }}" type="text/javascript"></script>
        <script src="{{ asset('assets/global/scripts/table2excel.js')}}" type="text/javascript"></script>
        ...
        <script>
          ...
          $('.datemonth').mask('2OZ0/X0', {
            translation: {
              'Z': {
                pattern: /[1-2]/, optional: true
              },
              'X': {
