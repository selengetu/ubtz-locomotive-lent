...
@section('content')
      ...
      <table class="table table-striped table-bordered table-hover"  id="testTable">
                                                  ...
                                                  @endif
                                                  <?php if($p!=$haluuns->station_id) { $p=$haluuns->station_id;
                                                      $i1=0;
                                                      $i2=0;
                                                      $i3=0;
                                                      $i4=0;

                                                  } else  { $p1=$haluuns->station_id; }?>
                                                  @if($p!=$p1 and $p>0)
                                                      <Tr><Td>{{$s}}</Td><td colspan="9" style="font-weight: bold;font-size: 12px;"> {{$haluuns->statfullname}}</td></Tr>
                                                      <?php $s++; ?>
                                                      <tr>
                                                          <td></td>
