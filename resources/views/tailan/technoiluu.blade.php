...
@section('content')
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">
                         Технологит хугацаанаас илүү зогссон
                        </span>
                    </div>
                                            ...
                                            <div id="sear" class="panel-collapse collapse in">
                                                <div class="panel-body">
                                                    <fieldset class="scheduler-border">
                                                     <form method="post" action="technoiluu">
                                        <div class="col-md-12">
                                                         <div class="col-md-3">
                                                            <div class="form-group form-md-line-input has-success">
                                                                <div class="input-icon">
                                                                <input class="form-control datepicker" id="techno_start" name="techno_start" type="text"  value="{{$startdate}}" /> 
                                                            ...
                                                            <div class="form-group form-md-line-input has-success">
                                                                <div class="input-icon">
                                                                  <input class="form-control datepicker" id="techno_end" name="techno_end" type="text" value="{{$enddate}}"> 
                                                                    <label for="form_control_1" style="font-size:12px;">
                                                                     Дуусах огноо
                                                                    </label>
                                                                    <span class="help-block">
                   ...
                   <div class="table-container">
                     <button class="btn btn-info" id="buttonprint" onclick="printDiv()"><i class="fa fa-print" aria-hidden="true"></i>Хэвлэх</button>
                      ...
                      <p><center><b> {{$startdate}} -аас {{$enddate}} -ны технологит хугацаанаас илүү орсон судалгаа</b></center> </p>
  ...
  $(document).ready(function() {
          $("#techno_start").datepicker({
        format: 'yyyy-mm-dd',
        todayBtn:  1,
        autoclose: true,
    }).on('changeDate', function (selected) {
        var minDate = new Date(selected.date.valueOf());
        $('#techno_end').datepicker('setStartDate', minDate);
    });
    
    $("#techno_end").datepicker({
        format: 'yyyy-mm-dd',
    })
        .on('changeDate', function (selected) {
            var minDate = new Date(selected.date.valueOf());
            $('#techno_start').datepicker('setEndDate', minDate);
        });
      $('#example').DataTable( {
...
var tablesToExcel=null;
     tablesToExcel = (function () {
        ...
        , body = '<body>   <p><center><b> {{$startdate}} -аас {{$enddate}} -ны технологит хугацаанаас илүү орсон судалгаа</b></center> </p>'
